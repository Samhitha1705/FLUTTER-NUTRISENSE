  ...
  Future<void> resetPassword() async {
    ...
    try {
      ...
      final response = await http.post(url,
          ...
          body: jsonEncode({"email": widget.email, "otp": widget.otp, "password": password}));
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(body["message"] ?? "Error resetting password")));
      }
    } catch (e) {
      setState(() => isLoading = false);
